...
public class ScalingManager {
	...
	/**
	 * Set the dimension of the canvas. Should be called every time the dimension of the canvas changes
	...
	/**
	 * Calculates the coordinates of the point on the media using the normal coordinates
	 * @param p point
	 */
	public Vector2 calcMediaCordWithNorm(Point p) {
		double x = p.getX() * mediaW;
		double y = p.getY() * mediaH;
